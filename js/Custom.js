...
var custom = {
    create: function () {
        ...
        this.bt_nextPlayer_1 = game.add.button(200, 400, 'spr_arrow', this.nextPlayer_1, this);
            this.bt_nextPlayer_1.anchor.setTo(0.5, 0.5);
        this.bt_prevPlayer_1 = game.add.button(100, 400, 'spr_arrow', this.prevPlayer_1, this);
            this.bt_prevPlayer_1.anchor.setTo(0.5, 0.5);
            this.bt_prevPlayer_1.scale.x = -1;

        this.bt_nextPlayer_2 = game.add.button(600, 400, 'spr_arrow', this.nextPlayer_2, this);
            this.bt_nextPlayer_2.anchor.setTo(0.5, 0.5);
        this.bt_prevPlayer_2 = game.add.button(500, 400, 'spr_arrow', this.prevPlayer_2, this);
            this.bt_prevPlayer_2.anchor.setTo(0.5, 0.5);
            this.bt_prevPlayer_2.scale.x = -1;
        
        this.bt_gameStart = game.add.button(300, 500, 'spr_button', this.gameStart, this);
            this.bt_gameStart.anchor.setTo(0.5, 0.5);
            this.bt_gameStart.scale.x = 0.5;
            this.bt_gameStart.scale.y = 0.5;

        //  햄찌 이름(별명) 입력창
        this.input_playerName_1 = game.add.inputField(game.width / 2 - 250, 325, {
            font: '30px BMJUA',
            fill: '#212121',
            width: 200,
            max: 4,
        ...
        this.input_playerName_2 = game.add.inputField(game.width / 2 + 250, 325, {
            font: '30px BMJUA',
            fill: '#212121',
            width: 200,
            max: 4,
